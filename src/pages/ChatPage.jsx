...
const ChatPage = ({ type, lottieData, avatarSrc, title, welcomeMsg }) => {
  ...
  const handleSend = async () => {
    ...
    // Make avatar speak the user's message
    if (isSessionActive) {
      await avatarSpeak(userText);
    }
  ...
  return (
    <div className="page-container">
      <div className="avatar-section">
        <Link to="/home" className="back-to-home" title="Back to home">
          ← Back
        </Link>
      ...
      <div className="chat-container">
        ...
        <div className="chat-input-container">
          ...
          />
          <button id="send-btn" onClick={handleSend} disabled={!isSessionActive}>Send</button>
          <button id="audio-btn" disabled={!isSessionActive} title="Voice message">
